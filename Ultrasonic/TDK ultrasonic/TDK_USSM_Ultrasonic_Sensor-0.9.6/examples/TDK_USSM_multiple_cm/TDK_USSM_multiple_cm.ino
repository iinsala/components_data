 ...
 *  Arduino Library to measure distance in centimeter (cm) for multiple sensors.
 *        
 *  HARDWARE SETUP:
 *  ==============
...
#define N_SENSORS  4
const int IoPins[N_SENSORS] = {2, 3, 4, 5}; // Trigger/Echo Pin of Ultrasonic Sensor
